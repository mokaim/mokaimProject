...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/update.js"></script>
                                    ...
                                    <form>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="subject" class="form-control" name="subject" value="${view._post_title}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group mb-5">
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="story" id="message" cols="30" rows="7" class="form-control" placeholder="Write your notes or questions here...">${view._post_content}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row justify-content-center mb-5">
                                            <div class="col-md-12">
                                                ...
                                                <div class="preview-images-zone">
                                                    ...
                                                    <c:forEach var="updateDTO" items="${imgList}">

                                                        <div class="preview-image">
                                                            <div class="image-zone">
                                                                <img src='${updateDTO._img_location}'>
                                                            </div>
                                                        </div>
...
<script type="text/javascript">
    ...
    //REST FUL 방식으로 Multipart 요청을 보내려면 콘텐츠 타입을 무조건 false 로 맞추어야한다.!!
    ...
    $(document).ready(function(){
        ...
        var postNumber = "<c:out value='${postNumber}'/>";
